...
public class Formulario extends javax.swing.JFrame {
    ...
    private Object objetos[] = {"Seleccionar", "Masculino", "Femenino"};
    private JComboBox genero = new JComboBox(objetos);
    ...
    private void cajasTexto() {
        ...
        genero.setBounds(200, 261, 249, 25);
        panel.add(genero);
    ...
    public void setGenero(Object e){
        this.genero.setSelectedItem(e);
    }
    public Object getGenero(){
        return this.genero.getSelectedItem();
    }
